...
![](/../assets/Snipaste_2020-10-02_18-14-27.png)
...
![](/../assets/Snipaste_2020-10-02_18-18-07.png)
...
![](/../assets/Snipaste_2020-10-02_18-22-04.png)
...
![](/../assets/Snipaste_2020-10-03_10-58-47.png)

#### 为什么Docker比较比vm快

1、**docker**有着比虚拟机更少的抽象层。由于docker不需要**Hypervisor**实现硬件资源虚拟化,运行在docker容器上的程序直接使用的都是实际物理机的硬件资源。因此在CPU、内存利用率上docker将会在效率上有明显优势。
2、**docker**利用的是宿主机的内核,而不需要**Guest OS**。因此,当新建一个 容器时,docker不需要和虚拟机一样重新加载一个操作系统内核仍而避免引寻、加载操作系统内核返个比较费时费资源的过程,当新建一个虚拟机时,虚拟机软件需要加载GuestOS,返个新建过程是分钟级别的。而docker由于直接利用宿主机的操作系统,则省略了返个过程,因此新建一个docker容器只需要几秒钟。
...
![](/../assets/Snipaste_2020-10-02_18-30-08.png)

美团

![](/../assets/Snipaste_2020-10-02_18-30-56.png)

蘑菇街

![](/../assets/Snipaste_2020-10-02_18-31-11.png)
...
![](/../assets/Snipaste_2020-10-02_18-46-16.png)
...
![](/../assets/Snipaste_2020-10-02_19-39-12.png)
...
![](/../assets/Snipaste_2020-10-02_19-48-53.png)

2、yum install -y docker-io

![](/../assets/Snipaste_2020-10-02_19-49-37.png)

3、安装后的配置文件： etc/sysconfig/docker

![](/../assets/Snipaste_2020-10-02_19-50-17.png)
...
![](/../assets/Snipaste_2020-10-02_20-19-10.png)
...
![](/../assets/Snipaste_2020-10-03_10-54-57.png)

run干了什么

![](/../assets/Snipaste_2020-10-03_10-55-24.png)
...
#### ![](/../assets/Snipaste_2020-10-03_11-09-33.png)OPTIONS 说明：
...
![](/../assets/Snipaste_2020-10-03_11-40-34.png)
...
![](/../assets/Snipaste_2020-10-03_13-23-17.png)
...
![](/../assets/Snipaste_2020-10-03_13-26-40.png)



### 小总结

![](/../assets/Snipaste_2020-10-03_13-30-12.png)
...
UnionFS (联合文件系统) : Union文件系统(UnionFS)是一种分层、轻量级并且高性能的文件系统，它支持对文件系统的修改作为一次提交来一层层的叠加，同时可以将不同目录挂载到同一个虚拟文件系统下(unite several directories into a singlevirtualfilesystem)。Union文件系统是Docker镜像的基础。镜像可以通过分层来进行继承，基于基础镜像(没有父镜像)可以制作各种具体的应用镜像。
...
**botfs(boot file system)**主要包含**bootloader**和**kernel**, **bootloader**主 要是引导加载**kernel**, **Linux**刚启动时会加载bootfs文件系统，在**Docker**镜像的最底层是**bootfs**。这一层与我们典型的**Linux/Unix**系统是一样的，包含boot加载器和内核。当boot加载完成之后整个内核就都在内存中了，此时内存的使用权己由bootfs转交给内核，此时系统也会卸载bootfs。
...
![](/../assets/Snipaste_2020-10-03_13-38-28.png)
...
![](/../assets/Snipaste_2020-10-03_13-40-06.png)



![](/../assets/Snipaste_2020-10-03_14-02-22.png)



### 为什么 Docker镜像想要采用这种分层结构
...
![](/../assets/Snipaste_2020-10-03_14-26-27.png)
...
![](/../assets/Snipaste_2020-10-03_14-28-22.png)



3、也即当前的tomcat运行实例是一个没有文档内容的容器，以他为模板commit一个没有doc的tomcat新镜像 atguigu/tomcat02

![](/../assets/Snipaste_2020-10-03_14-29-38.png)
...
![](/../assets/Snipaste_2020-10-03_15-30-44.png)
...
![](/../assets/Snipaste_2020-10-03_15-31-52.png)

容器和宿主机之间数据共享

![](/../assets/Snipaste_2020-10-03_15-32-19.png)

容器停止退出后，主机修改后的数据是否同步

![](/../assets/Snipaste_2020-10-03_15-33-03.png)

命令(带权限)

​	docker run -it -v /宿主机绝对路径目录:/容器内目录**:ro** 镜像名

![](/../assets/Snipaste_2020-10-03_15-33-49.png)
...
![](/../assets/Snipaste_2020-10-03_15-35-17.png)



File构建

![](/../assets/Snipaste_2020-10-03_15-35-37.png)

build后生成镜像

![](/../assets/Snipaste_2020-10-03_15-36-01.png)

获得一个新镜像zzyy/centos

run容器

![](/../assets/Snipaste_2020-10-03_15-36-31.png)

通过上述步骤，容器内的卷目录地址已经知道，对应的主机目录在哪

![](/../assets/Snipaste_2020-10-03_15-37-05.png)

**主机对应默认地址**

![](/../assets/Snipaste_2020-10-03_15-37-22.png)
...
![](/../assets/Snipaste_2020-10-03_15-40-46.png)
...
![](/../assets/Snipaste_2020-10-03_15-41-51.png)

doc2/doc3 分别在dataVolumeContainer2各自新增内容

#### 回到doc1可以看到02/03各自添加的都能共享了

![](/../assets/Snipaste_2020-10-03_15-42-46.png)

#### 删除doc1 doc2修改后doc3是否可以访问

![](/../assets/Snipaste_2020-10-03_15-43-31.png)

#### 删除doc02后doc3是否访问

![](/../assets/Snipaste_2020-10-03_15-43-57.png)

在进一步

![](/../assets/Snipaste_2020-10-03_15-44-11.png)

#### 新建doc04继承doc03 然后删除doc03

![](/../assets/Snipaste_2020-10-03_15-44-56.png)
...
![](/../assets/Snipaste_2020-10-03_17-32-12.png)
...
<img src="/../assets/Snipaste_2020-10-03_17-47-26.png" style="zoom:200%;" />

![](/../assets/Snipaste_2020-10-03_17-47-58.png)

小总结

![](/../assets/Snipaste_2020-10-03_17-48-16.png)
...
![](/../assets/Snipaste_2020-10-03_17-52-43.png)
...
![](/../assets/Snipaste_2020-10-03_17-53-44.png)

准备Dockerfile文件

myCentOS内容Dockerfile

![](/../assets/Snipaste_2020-10-03_17-54-40.png)
...
![](/../assets/Snipaste_2020-10-03_17-56-15.png)

#### 3、运行

docker run -it 新镜像名字:TAG 

![](/../assets/Snipaste_2020-10-03_17-57-09.png)
...
![](/../assets/Snipaste_2020-10-03_18-02-41.png)

制作CMD版可以查询IP信息的容器

![](/../assets/Snipaste_2020-10-03_18-03-11.png)
...
![](/../assets/Snipaste_2020-10-03_18-05-28.png)
...
![](/../assets/Snipaste_2020-10-03_18-12-29.png)

##### 5、构建

![](/../assets/Snipaste_2020-10-03_18-12-48.png)

构建完成

![](/../assets/Snipaste_2020-10-03_18-13-20.png)
...
![](/../assets/Snipaste_2020-10-03_18-14-42.png)
...
![](/../assets/Snipaste_2020-10-03_18-58-14.png)

##### 8、综合前 述容器卷测试的web服务test发布

![](/../assets/Snipaste_2020-10-03_18-58-56.png)
...
![](/../assets/Snipaste_2020-10-03_19-00-48.png)
...
![](/../assets/Snipaste_2020-10-04_11-38-56.png)

#### 从 docker hub(阿里云加速器)拉取mysql镜像到本地标签为5.6

![](/../assets/Snipaste_2020-10-04_11-40-13.png)
...
![](/../assets/Snipaste_2020-10-04_11-59-32.png)

#### 数据备份测试

![](/../assets/Snipaste_2020-10-04_12-02-59.png)
...
![](/../assets/Snipaste_2020-10-04_12-05-08.png)
...
![](/../assets/Snipaste_2020-10-04_12-28-49.png)

#### 测试持久化文件生成

![](/../assets/Snipaste_2020-10-04_12-29-12.png)
...
![](/../assets/Snipaste_2020-10-04_12-49-17.png)
...
![](/../assets/Snipaste_2020-10-04_12-50-48.png)
...
![](/../assets/Snipaste_2020-10-04_12-51-52.png)
...
![](/../assets/Snipaste_2020-10-04_12-53-02.png)

#### 3、创建镜像仓库

![](/../assets/Snipaste_2020-10-04_12-54-07.png)
...
![](/../assets/Snipaste_2020-10-04_12-56-10.png)

#### 5、公有云可以查询得到

![](/../assets/Snipaste_2020-10-04_12-56-53.png)

#### 6、查看详情

![](/../assets/Snipaste_2020-10-04_12-57-23.png)



### 将阿里云上的镜像下载到本地

![](/../assets/Snipaste_2020-10-04_12-59-00.png)
